      ...
      {kinds.map((kind) => {
        switch (kind) {
          ...
          case 'contact_support':
            // HI-HA: upstream fell back to mailto:support@learnhouse.io whenever no
            // platform URL was configured — which is our case by design, so every
            // error page sent users to a third party's support. Hide the button
            // instead when this deployment has no contact route.
