...
import learnhouseIcon from 'public/hiha-mark.png'
...
export default function AuthBrandingPanel({ org, welcomeText, title, subtitle }: AuthBrandingPanelProps) {
  ...
  const UNSPLASH_UTM = '?utm_source=HI-HA&utm_medium=referral'
              ...
              <div className="flex-1 flex items-center justify-center">
                <div className={cn(
                  ...
                  <Link prefetch href={getUriWithOrg(org?.slug, '/')}>
                    <div className="w-24 h-24 rounded-2xl ring-1 ring-inset ring-white/10 bg-neutral-950 flex items-center justify-center overflow-hidden">
                      {org?.logo_image ? (
                        <img
                  ...
                  <div className="space-y-1">
                    <h1 className="font-black text-3xl tracking-tight">{org?.name || 'HI-HA'}</h1>
                    {displayMessage && (
                      <p className={cn(
